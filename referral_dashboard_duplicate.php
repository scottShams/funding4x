        ...
        function renderChecklist() {
            checklistContainer.innerHTML = topics.map(topic => `
                <div id="topic-${topic.id}" data-id="${topic.id}"
                     class="topic-item p-4 rounded-xl shadow-md flex items-center justify-between border border-border-light ${topic.isCompleted ? 'completed border-success-green' : 'bg-white'}"

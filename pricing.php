...
<body class="min-h-screen flex flex-col">
    ...
    <main class="flex-grow flex flex-col items-center p-4 sm:p-8">
        <div class="w-full max-w-5xl">
            ...
            <div id="pricing-container" class="grid grid-cols-1 md:grid-cols-2 gap-8">

                <!-- Card 1 (New Position): PAID Option (Instant Access) -->
                <div id="card-fast" class="card-item pricing-card bg-card-white p-6 sm:p-8 rounded-xl shadow-2xl transition duration-500 border-4 border-trophy-gold transform scale-[1.03] lg:scale-100 lg:hover:scale-[1.05]">
                ...
                <div id="card-slow" class="card-item pricing-card bg-card-white p-6 sm:p-8 rounded-xl shadow-lg transition duration-300 border border-border-light lg:hover:shadow-xl lg:hover:border-primary-purple">
                    ...
                    <div class="flex flex-col items-center mb-6">
                        ...
                        <p class="text-6xl font-extrabold text-primary-purple leading-none">
    ...
    <script>
        ...
        function updatePriceDisplay(isDiscounted) {
            const instantAccessCard = document.getElementById('card-fast');
